...
<div id=formulario align="center">
	{!! Form::open(array('url'=>'almacen/pedidosDevoluciones/productoPedidoProveedor','method'=>'GET','autocomplete'=>'off','role'=>'search')) !!}
	<div>		
		<br>EAN:<input id="tags" class="form-control" name="searchText" placeholder="Buscar...">

                <br>
                <input type="hidden" class="form-control" name="tp_aproveedor_id_rproveedor" value="{{$id}}">
		Nombre:
		<input id="buscar2" class="form-control" name="searchText1" placeholder="Buscar..." ><br><input type="submit" class="btn btn-primary" value="Buscar">
		</br>
	...
	{!!Form::open(array('url'=>'almacen/pedidosDevoluciones/productoPedidoProveedor','method'=>'POST','autocomplete'=>'off'))!!}
    {{Form::token()}}
    ...
    <div>
    		...
    		<div align="center">
    		No. Remisión:  {{$id}}
			<input type="hidden" class="form-control" name="tp_aproveedor_id_rproveedor" value="{{$id}}"><br>
			</div>
		...
		<input type="hidden" class="form-control" name="total"><br>
		<div align="center">			
	...
	<div class="row">
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-condensed table-hover">
						...
						@foreach($detalleProveedor as $pc)
						<tr>
							<td>{{$pc->tp_aproveedor_id_rproveedor}}</td>
							...
							<td>{{$pc->total}}</td>
							<td>
								<a href="" data-target="#modal-delete-{{$pc->id_dpproveedor}}" data-toggle="modal"><button class="btn btn-danger">Eliminar</button></a>
							</td>
						</tr>
						@include('almacen.pedidosDevoluciones.productoPedidoProveedor.modal')
						@endforeach
					</table>
				</div>
			</div><br>
