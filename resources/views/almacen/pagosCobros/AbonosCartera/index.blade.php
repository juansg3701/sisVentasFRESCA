...
<div align="center" id=formulario>
	...
	{!!Form::open(array('url'=>'almacen/pagosCobros/AbonosCartera','method'=>'POST','autocomplete'=>'off'))!!}
    {{Form::token()}}
	...
	<div id=formulario>
		<div class="form-group">
			...
			<input type="hidden" name="banco_idBanco" value="1">
			<input type="hidden" class="form-control" name="id_cartera" value="{{$id}}">
			...
			Fecha de pago<input type="datetime" class="form-control" name="fecha" value="<?php echo date("Y/m/d H:i"); ?>"><br>
				...
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-condensed table-hover">
						...
						<tr>
							...
							@include('almacen.pagosCobros.AbonosCartera.modal')
						@endforeach
					</table>
