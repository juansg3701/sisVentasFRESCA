...
<body>
	...
	<br><br>{!!Form::model($proveedor,['method'=>'PATCH','route'=>['almacen.proveedor.update',$proveedor->id_proveedor]])!!}
	{{Form::token()}}<br><br><br>
	...
	<div class="col-md-12">
		<div class="card">
			...
			<div class="col-sm-12" align="center">
				Editar datos de: {{$proveedor->nombre_empresa}}
			</div><br>
			<div class="row" align="center">	
						...
						<div class="card" align="center">
			                ...
			                <div class="card-body card-block" align="center">
								...
								<div class="form-row">
									...
									<div class="form-group col-sm-8">
										<input type="number" class="form-control" name="documento" min="0" value="{{$proveedor->documento}}">
									</div>
								</div>
