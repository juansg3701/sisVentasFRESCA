...
<div align="center"><h3>COMPARAR REPORTES PRODUCTOS-PROVEEDOR<h3></div>
...
{!!Form::close()!!} 
    <div align="center"><a href="{{URL::action('reportesInventario2@index',0)}}"><button class="btn btn-danger">Volver</button></a></div>
...
<div class="col-sm-6">  
  <div id="piechart2" style="width: 600px; height: 300px;"></div></div>
</div>     
@stop