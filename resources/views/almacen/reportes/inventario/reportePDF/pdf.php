...
$pdf->SetFont('Arial','I',8);
    ...
    $pdf->Cell(25,5,'NO.FACTURA',1,0,"C",true);
    $pdf->Cell(70,5,'PRODUCTO',1,0,"C",true);
    $pdf->Cell(25,5,'CANTIDAD',1,0,"C",true);
    $pdf->Cell(25,5,'PAGO TOTAL',1,1,"C",true);
    ...
    while($row = $prodSed->fetch_assoc()){
        ...
        for($i=0; $i<$longitud; $i++){
            ...
            if ($row['producto_id_producto'] == $vector_id[$i]) {
                ...
                $pdf->Cell(25,5,$row['noFactura'],1,0,'C',0);
                $pdf->Cell(70,5,$vector_nombre[$i],1,0,'C',0);
