...
<body>
	<div class="row" align="center">
			<div align="center"><h3>REPORTES PRODUCTOS-SEDE</h3></div><br>
			@if (count($errors)>0)
				...
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-condensed table-hover">
						...
						<tr>
							...
							<td>
								<a href="{{URL::action('reportesInventarioEX@edit',$rep->id_rInventarios)}}"><button class="btn btn-info">Gráfica</button></a>
								<a href="{{URL::action('reportesInventarioPDF@edit',$rep->id_rInventarios)}}"><button class="btn btn-warning"><i>pdf</i></button></a>
								<a href="{{URL::action('reportesInventarioEX@show',$rep->id_rInventarios)}}"><button class="btn btn-success"><i>xls</i></button></a>
