...
<body>
	<div class="row" align="center">
			<div align="center"><h3>REPORTES PEDIDOS-PROVEEDOR</h3></div><br>
			@if (count($errors)>0)
	...
	<div id=formulario>
	{!!Form::open(array('url'=>'almacen/reportes/pedidos2','method'=>'POST','autocomplete'=>'off'))!!}
    {{Form::token()}}
			<div id=formulario>
				...
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-condensed table-hover">
						...
						<tr>
							...
							<td>
								<a href="{{URL::action('reportesPedidosEX2@edit',$rep->id_rPedidos)}}"><button class="btn btn-info">Gráfica</button></a>
								<a href="{{URL::action('reportesPedidosPDF2@edit',$rep->id_rPedidos)}}"><button class="btn btn-warning"><i>pdf</i></button></a>
								<a href="{{URL::action('reportesPedidosEX2@show',$rep->id_rPedidos)}}"><button class="btn btn-success"><i>xls</i></button></a>
							
								<a href="" data-target="#modal-delete-{{$rep->id_rPedidos}}" data-toggle="modal"><button class="btn btn-danger">Eliminar</button></a>
							</td>
						</tr>
						@include('almacen.reportes.pedidos2.modal')	
						@endforeach
					</table>
				</div>
