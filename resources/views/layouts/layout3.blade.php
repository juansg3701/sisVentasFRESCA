                ...
                <ul class="nav navbar-nav">
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                        
                            ...
                            <li><i class="fa fa-id-badge"></i><a href="{{url('almacen/usuario/permiso/cargo')}}">Cargos</a>
                            </li>
                            <li><i class="fa fa-id-badge"></i><a href="{{url('almacen/usuario/permiso/usuario')}}">Permisos de usuarios</a>
                            </li>
                            <li><i class="fa fa-id-badge"></i><a href="{{url('almacen/usuario/permiso/cuenta')}}">Cuentas</a>
                            </li>
